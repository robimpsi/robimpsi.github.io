...
## 2026-06-16 - Tingkat Churn (Churn Rate)
**Analogy:** Pintu Keluar Diam-diam (The Silent Exit).
**Effectiveness:** Sangat efektif untuk menggambarkan bagaimana pelanggan yang hilang seringkali tidak memberikan keluhan, sehingga peritel tidak sadar bahwa mereka sedang kehilangan bisnis. Ini mengalihkan fokus dari sekadar akuisisi pelanggan ke retensi.
**Refinement:** Gunakan analogi ini untuk menekankan pentingnya sistem pelacakan pelanggan (seperti program loyalitas) untuk mendeteksi pelanggan yang "diam-diam" pergi.
