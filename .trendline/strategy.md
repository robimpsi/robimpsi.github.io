...
## 2026-02-25 - Nilai Seumur Hidup Pelanggan (Customer Lifetime Value)
**Analogy:** Pohon Buah (Fruit Tree).
**Effectiveness:** Memisahkan biaya tinggi penanaman (akuisisi) dari panen berkelanjutan (retensi). Sangat efektif untuk menggeser fokus peritel dari mengejar pelanggan baru ke arah merawat pelanggan yang sudah ada.
**Refinement:** Gunakan contoh bibit yang mahal vs. hasil panen jangka panjang untuk menekankan pentingnya ROI dalam strategi loyalitas.
