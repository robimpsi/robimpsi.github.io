...
## 2026-05-24 - Tingkat Pengembalian (Return Rate)
**Analogy:** Laba Bayangan (Shadow Profit).
**Effectiveness:** Sangat efektif untuk menyadarkan peritel bahwa penjualan kotor yang tinggi bisa menipu jika tingkat pengembalian tidak dikelola. Analogi ini memberikan beban emosional pada angka pengembalian, mengubahnya dari sekadar masalah administratif menjadi masalah profitabilitas inti.
**Refinement:** Tekankan pada biaya operasional tambahan yang muncul dari setiap barang yang dikembalikan untuk memperkuat argumen "kehilangan ganda" (omzet hilang + biaya operasional bertambah).
