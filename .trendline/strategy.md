...
**Effectiveness:** Sangat efektif untuk menggambarkan kesia-siaan upaya akuisisi pelanggan (menimba air) jika masalah retensi (lubang di dasar perahu) tidak diperbaiki terlebih dahulu. Ini memberikan visualisasi yang kuat tentang kehilangan modal dan potensi pertumbuhan.
**Refinement:** Tekankan bahwa memperbaiki kebocoran (retensi) seringkali jauh lebih berdampak pada stabilitas kapal daripada sekadar menimba lebih cepat (iklan/promosi).
